...
//     virtual ~Device() = default;
    ...
    // create_shader(const std::string &code, const vk::ShaderStageFlagBits
    // &stage,
    //               const std::string &name) = 0;

    // virtual std::shared_ptr<VulkanPipeline>
    // create_pipeline(const std::vector<std::shared_ptr<VulkanShader>>
    // &shaders,
...
//             {}, code.size(), reinterpret_cast<const uint32_t
//             *>(code.data()));
...
//     VulkanImageBuffer(std::shared_ptr<BufferBinding<vk::UniqueImage>>
//     &&binding,
