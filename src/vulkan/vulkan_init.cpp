...
class HelloTriangleApplication {
  ...
  private:
    ...
    // the object will be implicitly destroyed when the VKInstance is destroyed
    ...
    void createInstance() {
        ...
        // Not optional:
        // configure global extensions and validation layer
    ...
    void createGraphicsPipeline() {
        auto vertShaderCode = readFile("debug/shaders/shader.vert.spv");
        auto fragShaderCode = readFile("debug/shaders/shader.frag.spv");
    ...
    std::vector<const char *> getRequiredExtensions() {
        ...
        printf("required extensions of application\n");
    ...
    void printAvailableLayers() {
        ...
        for (const auto &layerProperties : availableLayers) {
            printf("layer name: %s\n"
                   ...
                   VK_VERSION_MAJOR(layerProperties.implementationVersion),
                   VK_VERSION_MINOR(layerProperties.implementationVersion),
                   VK_VERSION_PATCH(layerProperties.implementationVersion),
